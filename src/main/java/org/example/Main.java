...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        Account account2 = new Account(0,"345");

        System.out.println("Потоки начали работу.");
        System.out.println();
        ...
        System.out.println("Баланс счета: "+account.getAccountNumber()+" составляет: " + account.getBalance()+" сом.");
        System.out.println("Баланс счета: "+account2.getAccountNumber()+" составляет: " + account2.getBalance()+" сом.");
    }
}