...
//        lock.lock();
        lock2.acquire();
        int amount = rn.nextInt(1000);

        this.setBalance(this.getBalance() + amount);

        System.out.println("Баланс пополнен на: "+amount+" сом");
        System.out.println("Баланс счета: "+this.getAccountNumber()+" составляет: "+this.getBalance()+" сом");
...
//        lock.lock();
        ...
        if(this.balance>amount){
            ...
            System.out.println("Снятие суммы: "+amount+ " невозможно.");
        }
